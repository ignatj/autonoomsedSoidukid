...
class CarNavigationNode(Node):
    ...
    def __init__(self):
        ...
        initial_pose.pose.pose.position.x = 3753.356201171875
        initial_pose.pose.pose.position.y = 73769.984375
        initial_pose.pose.pose.orientation.x = 0.0
        initial_pose.pose.pose.orientation.y = 0.0
        initial_pose.pose.pose.orientation.z = -0.5102105776693161
        initial_pose.pose.pose.orientation.w = 0.8600495139434373
        ...
        self.goal_poses.append({'x': 3778.23828125, 'y': 73722.2890625, 'xx': 0.0, 'yy': 0.0, 'zz': -0.5230496544145751, 'w': 0.8523022110828962})
        self.goal_poses.append({'x': 3808.419921875, 'y': 73718.7265625, 'xx': 0.0, 'yy': 0.0, 'zz': 0.21746131222033185, 'w': 0.9760689410525321})
        self.goal_poses.append({'x': 3830.02099609375, 'y': 73730.1640625, 'xx': 0.0, 'yy': 0.0, 'zz': 0.20996969896452877, 'w': 0.9777078937580207})
